...
export default function EditAnnouncementPage() {
  ...
  const loadAnnouncement = async () => {
    try {
      ...
      setPreviewUrl(getImageUrl(data.imageUrl));
    } catch (error) {
        ...
        <div className="card p-6 mb-6">
          ...
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Upload a new image to replace the current one. Recommended: 1920x1080px or similar
              ratio. Images will be automatically compressed for optimal quality and size.
            </p>
          </div>
